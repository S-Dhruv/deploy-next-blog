import {MongoDBAdapter, FileDBAdapter, type DatabaseAdapter} from "@supergrowthai/next-blog";
...
if (useMongo) {
    ...
    dbProvider = async () => {
        ...
        return new MongoDBAdapter(process.env.MONGO_DB_NAME || "next-blog", client);
    };
